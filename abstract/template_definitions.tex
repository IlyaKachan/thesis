...
\setlength{\hoffset}{-9mm} \setlength{\voffset}{-8mm}
\setlength{\textheight}{245mm}% размеры текста по высоте без колонтитула
\setlength{\textwidth}{168mm}% размеры текста по ширине
...
\setlength{\parindent}{12.5mm} \setlength{\linespread}{1}
...
\renewcommand\theequation{\@arabic\c@equation}%первые chapter и section
